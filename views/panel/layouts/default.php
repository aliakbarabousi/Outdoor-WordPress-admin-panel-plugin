...
<head>
    ...
    <title>LaraCMS</title>
    <link href="<?php echo UPP_ASSETS?>css/lib/bootstrap/bootstrap-rtl.min.css" rel="stylesheet">
...
<div id="main-wrapper">
        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">
                    <!-- Logo icon -->
                    <b><img src="<?php echo UPP_ASSETS?>images/logo.png" alt="homepage" class="dark-logo"/></b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span><img src="<?php echo UPP_ASSETS?>images/logo-text.png" alt="homepage" class="dark-logo"/></span>
                </a>
            </div>
            <!-- End Logo -->
                ...
                <ul class="navbar-nav my-lg-0">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="message-center">
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="<?php echo UPP_ASSETS?>images/users/5.jpg" alt="user"
                                        ...
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="<?php echo UPP_ASSETS?>images/users/2.jpg" alt="user"
                                                                       class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="<?php echo UPP_ASSETS?>images/users/3.jpg" alt="user"
                                                                       class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="<?php echo UPP_ASSETS?>images/users/4.jpg" alt="user"
                                                                       class="img-circle"> <span
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false"><img src="<?php echo UPP_ASSETS?>images/users/5.jpg" alt="user"
                                                                           class="profile-pic"/></a>
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <?php include UPP_VIEW_INDEX.$index_view ?>
...
<script src="<?php echo UPP_ASSETS?>js/lib/jquery/jquery.min.js"></script>
<!-- Bootstrap tether Core JavaScript -->
<script src="<?php echo UPP_ASSETS?>js/lib/bootstrap/js/popper.min.js"></script>
<script src="<?php echo UPP_ASSETS?>js/lib/bootstrap/js/bootstrap.min.js"></script>
<!-- slimscrollbar scrollbar JavaScript -->
<script src="<?php echo UPP_ASSETS?>js/jquery.slimscroll.js"></script>
<!--Menu sidebar -->
<script src="<?php echo UPP_ASSETS?>js/sidebarmenu.js"></script>
<!--stickey kit -->
<script src="<?php echo UPP_ASSETS?>js/lib/sticky-kit-master/dist/sticky-kit.min.js"></script>
<!--Custom JavaScript -->
<script src="<?php echo UPP_ASSETS?>js/custom.min.js"></script>
</body>
</html>